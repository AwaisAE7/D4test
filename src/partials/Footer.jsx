      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <a href="#" className="text-white hover:text-green-400 transition duration-150 ease-in-out">Documentation</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-white hover:text-green-400 transition duration-150 ease-in-out">Tutorials & Guides</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-white hover:text-green-400 transition duration-150 ease-in-out">Blog</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-white hover:text-green-400 transition duration-150 ease-in-out">Support Center</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-white hover:text-green-400 transition duration-150 ease-in-out">Partners</a>
              </li>
            </ul>
          </div>
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <a href="#" className="text-white hover:text-green-400 transition duration-150 ease-in-out">Home</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-white hover:text-green-400 transition duration-150 ease-in-out">About us</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-white hover:text-green-400 transition duration-150 ease-in-out">Company values</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-white hover:text-green-400 transition duration-150 ease-in-out">Pricing</a>
              </li>
              <li className="mb-2">
